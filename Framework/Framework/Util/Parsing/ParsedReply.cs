...
namespace Framework.Util.Parsing
{
    ...
    public class ParsedReply
    {
        ...
        public override string ToString()
        {
            ...
            foreach(Guid parinte in this._parents)
            {
                stringRepresentation += "(" + parinte + ")";
            }

            stringRepresentation += "), Copii=(";

            foreach (Guid copil in this._children)
            {
                stringRepresentation += "(" + copil + ")";
            }
